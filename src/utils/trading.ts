...
export default async function Deposit(provider, userAddress, amount/* BUSD amount */, days/* Lock Period */) {
    ...
    const txDeposit = await tradingContract.deposit(sendAmount, days, {
        from: userAddress
    });
