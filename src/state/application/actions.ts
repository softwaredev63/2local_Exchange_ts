...
export const toggleIndacoinCheckoutModal = createAction<void>('app/toggleIndacoinCheckoutModal')
export const toggleIndacoin2LCCheckoutModal = createAction<void>('app/toggleIndacoin2LCCheckoutModal')