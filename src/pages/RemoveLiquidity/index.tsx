...
import CurrencyInputPanelOrg from '../../components/CurrencyInputPanelOrg'
...
import CurrencyLogoOrg from '../../components/CurrencyLogoOrg'
    ...
    return (
      <AutoColumn gap="md" style={{ marginTop: '20px' }}>
        <RowBetween align="flex-end">
          ...
          <RowFixed gap="4px">
            <CurrencyLogoOrg currency={currencyA} size="24px" />
        ...
        <RowBetween align="flex-end">
          ...
          <RowFixed gap="4px">
            <CurrencyLogoOrg currency={currencyB} size="24px" />
            <Text fontSize="24px" style={{ marginLeft: '10px' }}>
              {currencyB?.symbol}
            </Text>
          </RowFixed>
                  ...
                  <OutlineCard>
                    <AutoColumn gap="10px">
                      <RowBetween>
                        ...
                        <RowFixed>
                          <CurrencyLogoOrg currency={currencyA} style={{ marginRight: '12px' }} />
                      ...
                      <RowBetween>
                        ...
                        <RowFixed>
                          <CurrencyLogoOrg currency={currencyB} style={{ marginRight: '12px' }} />
